...
public class KuberaMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kuberamantra);
        ...
        player = MediaPlayer.create(KuberaMantra.this, R.raw.kubera);
        seekBar.setMax(0);
