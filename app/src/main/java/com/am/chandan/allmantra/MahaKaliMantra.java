...
public class MahaKaliMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kalimantra);
        ...
        player = MediaPlayer.create(MahaKaliMantra.this, R.raw.kalima);
        seekBar.setMax(0);
