...
public class ShreeKrishnaMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shreekrishnamantra);
        ...
        player = MediaPlayer.create(ShreeKrishnaMantra.this, R.raw.krishna);
        seekBar.setMax(0);
