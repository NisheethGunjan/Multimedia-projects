...
public class SaiBabaMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saibabamantra);
        ...
        player = MediaPlayer.create(SaiBabaMantra.this, R.raw.sai);
        seekBar.setMax(0);
