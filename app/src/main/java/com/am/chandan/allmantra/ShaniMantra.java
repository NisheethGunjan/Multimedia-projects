...
public class ShaniMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shanimantra);
        ...
        player = MediaPlayer.create(ShaniMantra.this, R.raw.shani);
        seekBar.setMax(0);
