...
public class MahaLakshmiMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.laxmimantra);
        ...
        player = MediaPlayer.create(MahaLakshmiMantra.this, R.raw.lakshmi);
        seekBar.setMax(0);
