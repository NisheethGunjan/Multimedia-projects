...
public class GanpatiMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ganeshamantra);
        ...
        player = MediaPlayer.create(GanpatiMantra.this, R.raw.ganpati);
        seekBar.setMax(0);
