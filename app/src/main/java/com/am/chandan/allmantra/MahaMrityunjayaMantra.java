...
public class MahaMrityunjayaMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mahamrityunjaya);
        ...
        player = MediaPlayer.create(MahaMrityunjayaMantra.this, R.raw.mahamrityunjaya);
        seekBar.setMax(0);
