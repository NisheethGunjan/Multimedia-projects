...
public class OmNamahShivayaMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.omnamahshivaya);
        ...
        player = MediaPlayer.create(OmNamahShivayaMantra.this, R.raw.omnamahshivaya);
        seekBar.setMax(0);
