...
public class GayatriMantra extends AppCompatActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gayatrimantra);
        ...
        player = MediaPlayer.create(GayatriMantra.this, R.raw.gayatri);
        seekBar.setMax(0);
